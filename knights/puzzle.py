...
knowledge2 = And(
    ...
    Implication(AKnight, Or(Or(And(AKnave,BKnight), And(AKnight,BKnave)))),
)
...
knowledge3 = And(
    main_knowledge,
    Or(And(Implication(AKnight, AKnight), Implication(AKnave,Not(AKnight))), And(Implication(AKnight,AKnave), Implication(AKnave,Not(AKnave)))),
